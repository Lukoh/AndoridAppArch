...
package com.goforer.goforerarchblueprint.di.helper;
...
public class AppInjector {
    ...
    public static void init(GoforerArchBlueprint archBlueprint) {
        DaggerAppComponent.builder().application(archBlueprint)
                .build().inject(archBlueprint);

        archBlueprint.registerActivityLifecycleCallbacks(
