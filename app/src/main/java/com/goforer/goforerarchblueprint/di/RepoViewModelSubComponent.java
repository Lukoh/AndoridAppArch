...
/**
 * A sub component to create RepoViewModel. It is called by the
 * {@link GoforerArchBlueprint}.
 * Using this component allows RepoViewModel to define {@link javax.inject.Inject} constructors.
 */
@Subcomponent
public interface RepoViewModelSubComponent {
    @Subcomponent.Builder
    interface Builder {
        RepoViewModelSubComponent build();
    }
